...
# MiniDev-Logistic:  ms-transports

La presente iniciativa contiene el codigo de un mini desarrollo de software BackEnd.
En particular, este proyecto contiene el modulo denominado ms-transports.
...
In particular, this project contains the module called ms-transports.
